...
const mask = [
    ...
    },
    {
        ...
        cardType: "\u041C\u0418\u0420",
        icon: '<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="mir" fill-rule="nonzero"><linearGradient xmlns="http://www.w3.org/2000/svg" id="a" x1="370" x2="290" gradientUnits="userSpaceOnUse"><stop stop-color="#1F5CD7"/><stop stop-color="#02AEFF" offset="1"/></linearGradient><path xmlns="http://www.w3.org/2000/svg" d="m31 13h33c3 0 12-1 16 13 3 9 7 23 13 44h2c6-22 11-37 13-44 4-14 14-13 18-13h31v96h-32v-57h-2l-17 57h-24l-17-57h-3v57h-31m139-96h32v57h3l21-47c4-9 13-10 13-10h30v96h-32v-57h-2l-21 47c-4 9-14 10-14 10h-30m142-29v29h-30v-50h98c-4 12-18 21-34 21" fill="#0f754e"/><path xmlns="http://www.w3.org/2000/svg" d="m382 53c4-18-8-40-34-40h-68c2 21 20 40 39 40" fill="url(#a)"/></g></g>',
        logo: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 120"><linearGradient id="a" x1="370" x2="290" gradientUnits="userSpaceOnUse"><stop stop-color="#1F5CD7"/><stop stop-color="#02AEFF" offset="1"/></linearGradient><path d="m31 13h33c3 0 12-1 16 13 3 9 7 23 13 44h2c6-22 11-37 13-44 4-14 14-13 18-13h31v96h-32v-57h-2l-17 57h-24l-17-57h-3v57h-31m139-96h32v57h3l21-47c4-9 13-10 13-10h30v96h-32v-57h-2l-21 47c-4 9-14 10-14 10h-30m142-29v29h-30v-50h98c-4 12-18 21-34 21" fill="#0f754e"/><path d="m382 53c4-18-8-40-34-40h-68c2 21 20 40 39 40" fill="url(#a)"/></svg>',
        color: "cyan"
    },
    {
        mask: "0000 0000 0000 0000",
...
const titleCreate = ()=>{
    const paymentTitle = (0, _redom.el)('.payment-title');
    const h1 = (0, _redom.el)('h1', 'Payment Information');
    (0, _redom.setChildren)(paymentTitle, h1);
    return paymentTitle;
};
const cardCreate = ()=>{
    const container = (0, _redom.el)('.container');
    const creditcard = (0, _redom.el)('.creditcard', {
        onclick (e) {
            e.target.closest('.creditcard').classList.toggle('flipped');
        }
    });
    (0, _redom.setChildren)(container, creditcard);
    const front = (0, _redom.el)('.front');
    const ccsingle = (0, _redom.el)('#ccsingle');
    /*
  const cardfront = svg(
    'svg',
    svg("symbol", {
      ...
      'xml:space': 'preserve',
    }));*/ const cardfront = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    cardfront.setAttribute('id', 'cardfront');
    cardfront.setAttribute('xmlns', 'http://www.w3.org/2000/svg');
    cardfront.setAttribute('xmlns:xlink', 'http://www.w3.org/1999/xlink');
    cardfront.setAttribute('x', '0px');
    cardfront.setAttribute('y', '0px');
    cardfront.setAttribute('viewBox', '0 0 750 471');
    cardfront.setAttribute('style', 'enable-background:new 0 0 750 471;');
    cardfront.setAttribute('xml:space', 'preserve');
    cardfront.innerHTML = `<g id="Front">
<g id="CardBackground">
  <g id="Page-1_1_">
    <g id="amex_1_">
...
<text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname"
  class="st2 st5 st6">\u{418}\u{412}\u{410}\u{41D} \u{418}\u{412}\u{410}\u{41D}\u{41E}\u{412}</text>
...
<g id="Back">
    ...
    (0, _redom.setChildren)(front, [
        ccsingle,
        cardfront
    ]);
    const back = (0, _redom.el)('.back');
    const cardback = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    cardback.setAttribute('id', 'cardback');
    cardback.setAttribute('xmlns', 'http://www.w3.org/2000/svg');
    cardback.setAttribute('xmlns:xlink', 'http://www.w3.org/1999/xlink');
    cardback.setAttribute('x', '0px');
    cardback.setAttribute('y', '0px');
    cardback.setAttribute('viewBox', '0 0 750 471');
    cardback.setAttribute('style', 'enable-background:new 0 0 750 471;');
    cardback.setAttribute('xml:space', 'preserve');
    cardback.innerHTML = `<g id="Front">
...
<text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback"
  class="st12 st13">\u{418}\u{432}\u{430}\u{43D} \u{418}\u{432}\u{430}\u{43D}\u{43E}\u{432}</text>
    ...
    (0, _redom.setChildren)(back, cardback);
...
const formCreate = ()=>{
    ...
    const formContainer = (0, _redom.el)('.form-container');
    const fieldContainerName = (0, _redom.el)('.field-container');
    const labelName = (0, _redom.el)('label', {
        for: 'name'
    }, 'Name');
    ...
    (0, _redom.setChildren)(fieldContainerName, [
        labelName,
        inputName
    ]);
    const fieldContainerCard = (0, _redom.el)('.field-container');
    ...
    const labelCard = (0, _redom.el)('label', {
        for: 'cardnumber'
    }, 'Card Number');
    const inputCard = (0, _redom.el)('input', {
        id: 'cardnumber',
        pattern: '[0-9]*',
        inputmode: 'numeric',
        type: 'text'
        ...
        oninput (e) {
            for(let i = 0; i < mask.length; i++)if (e.target.value.match(mask[i].regex)) {
                const maskOptions = {
                    mask: mask[i].mask
                };
                IMask(e.target, maskOptions);
                ccicon.innerHTML = mask[i].icon;
                ccsingle.innerHTML = mask[i].logo;
    ...
    (0, _redom.setChildren)(fieldContainerCard, [
        labelCard,
        inputCard,
        ccicon
    ]);
    const fieldContainerExpirationDate = (0, _redom.el)('.field-container');
    const labelExpirationDate = (0, _redom.el)('label', {
        for: 'expirationdate'
    }, 'Expiration (mm/yy)');
    const inputExpirationDate = (0, _redom.el)('input', {
        id: 'expirationdate',
        pattern: '[0-9]*',
        inputmode: 'numeric',
        type: 'text'
        ...
        onkeyup (e) {
            svgexpire.textContent = e.target.value;
        }
    });
    IMask(inputExpirationDate, {
        mask: '00/00'
    });
    (0, _redom.setChildren)(fieldContainerExpirationDate, [
        labelExpirationDate,
        inputExpirationDate
    ]);
    const fieldContainerSecurityCode = (0, _redom.el)('.field-container');
    const labelSecurityCode = (0, _redom.el)('label', {
        for: 'securitycode'
    }, 'Security Code');
    const inputSecurityCode = (0, _redom.el)('input', {
        id: 'securitycode',
        pattern: '[0-9]*',
        inputmode: 'numeric',
        type: 'text'
    ...
    IMask(inputSecurityCode, {
        mask: '000'
    });
    (0, _redom.setChildren)(fieldContainerSecurityCode, [
        labelSecurityCode,
        inputSecurityCode
    ]);
    (0, _redom.setChildren)(formContainer, [
        fieldContainerName,
        fieldContainerCard,
        fieldContainerExpirationDate,
        fieldContainerSecurityCode
    ]);
    return formContainer;
};
const createApp = ()=>{
    const title = titleCreate();
    (0, _redom.mount)(document.body, title);
    const card = cardCreate();
    (0, _redom.mount)(document.body, card);
    const form = formCreate();
    (0, _redom.mount)(document.body, form);
};
createApp();

},{"redom":"9CzRX"}],"9CzRX":[function(require,module,exports,__globalThis) {
...
},{}]},["n0fw4","kTBnD"], "kTBnD", "parcelRequire7fc0", {})

//# sourceMappingURL=credit-card-2lvl.3c14d121.js.map
